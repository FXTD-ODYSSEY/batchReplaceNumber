...
class CSSReplaceWindow(QtWidgets.QWidget):
    ...
    def outputFile(self):
        ...
        if not divide_num:
            QtWidgets.QMessageBox.warning(self,"警告","相乘数值不能为零")
            return
        ...
        def numberHandler(matched):
            ...
            return str(value * divide_num) + "rpx"  #保留两位小数,并把单位转为rpx
